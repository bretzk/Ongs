        ...
        <div class="row full-height justify-content-center">
          <div class="col-12 text-center align-self-center py-5">
            <div class="section pb-5 pt-5 pt-sm-2 text-center">
              <h6 class="mb-0 pb-3">
                <span>Log In </span><span>Registrar</span>
              </h6>
              <input
                class="checkbox"
                type="checkbox"
                        ...
                        <div class="form-group">
                          <form action="loginbd.php" method="POST">
                              ...
                              <div class="form-group mt-2">
                                ...
                                <input type="submit" name=submit class="btn mt-4" value="Login">
                      ...
                      <div class="section text-center">
                        <h4 class="mb-3 pb-3">Registrar</h4>
                          <form action="registrobd.php" method="POST">
                            ...
                            <input type="submit" name="submit" class="btn mt-4" value="registrar">
                          </form>
                      </div>
                    </div>
                  </div>
